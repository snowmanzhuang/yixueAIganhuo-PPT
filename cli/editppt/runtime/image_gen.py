#!/usr/bin/env python3
"""Unified CLI for yixueAIganhuo-PPT image generation or editing.
...
def _cli_reinstall_hint() -> str:
    return "`pipx install --force --editable <path-to-yixueAIganhuo-PPT>/cli`"
...
def _dependency_hint(package: str, *, upgrade: bool = False) -> str:
    ...
    return (
        "Install yixueAIganhuo-PPT with pipx so CLI dependencies are installed, for example "
...
asset sheets, and batch image jobs in yixueAIganhuo-PPT runs.
""",
