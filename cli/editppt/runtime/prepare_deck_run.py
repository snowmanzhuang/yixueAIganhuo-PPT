...
def main():
    parser = argparse.ArgumentParser(description="Create a stable yixueAIganhuo-PPT run directory.")
    parser.add_argument("inputs", nargs="+")
    parser.add_argument("--out-root", default="output/yixueAIganhuo-PPT")
